...
<div class="row " id="infoboard4">
    ...
    <div class='columns large-5'>
        ...
        <div class="callout primary info-callout text-center qHeader qHeader2">
            <span data-title="#q2" >University College Enrolment</span>
        </div>
...
<div class="row">
    ...
    <ul class="marquee" id="feed-ticker">
        ...
        <li>// Your Students’ Union is here to represent you and make you time at 
                B&FC as interesting and enjoyable as possible //</li>
        
        <li>// Make a date: Freshers Fairs take place at the Bispham Campus on 
                Tuesday 20 September and University Centre on Thursday 22 September //</li>
